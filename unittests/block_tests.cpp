...
BOOST_AUTO_TEST_CASE(block_with_invalid_tx_test)
{
   ...
   signed_tx.sign(main.get_private_key(N(myeosio), "active"), main.control->get_chain_id());
   ...
   copy_b->producer_signature = main.get_private_key(N(myeosio), "active").sign(sig_digest);
