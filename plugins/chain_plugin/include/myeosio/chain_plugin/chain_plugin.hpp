...
FC_REFLECT( myeosio::chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT( myeosio::chain_apis::empty, )
FC_REFLECT( myeosio::chain_apis::read_only::get_info_results,
...
FC_REFLECT( myeosio::chain_apis::read_only::get_block_params, (block_num_or_id))
FC_REFLECT( myeosio::chain_apis::read_only::get_block_header_state_params, (block_num_or_id))

FC_REFLECT( myeosio::chain_apis::read_write::push_transaction_results, (transaction_id)(processed) )

FC_REFLECT( myeosio::chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit) )
FC_REFLECT( myeosio::chain_apis::read_only::get_table_rows_result, (rows)(more) );

FC_REFLECT( myeosio::chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
FC_REFLECT( myeosio::chain_apis::read_only::get_currency_stats_params, (code)(symbol));
FC_REFLECT( myeosio::chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));

FC_REFLECT( myeosio::chain_apis::read_only::get_producers_params, (json)(lower_bound)(limit) )
FC_REFLECT( myeosio::chain_apis::read_only::get_producers_result, (rows)(total_producer_vote_weight)(more) );

FC_REFLECT( myeosio::chain_apis::read_only::get_account_results,
            (account_name)(head_block_num)(head_block_time)(privileged)(last_code_update)(created)
            (core_liquid_balance)(ram_quota)(net_weight)(cpu_weight)(net_limit)(cpu_limit)(ram_usage)(permissions)
            (total_resources)(self_delegated_bandwidth)(refund_request)(voter_info) )
FC_REFLECT( myeosio::chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(wasm)(abi) )
FC_REFLECT( myeosio::chain_apis::read_only::get_abi_results, (account_name)(abi) )
FC_REFLECT( myeosio::chain_apis::read_only::get_account_params, (account_name) )
FC_REFLECT( myeosio::chain_apis::read_only::get_code_params, (account_name)(code_as_wasm) )
FC_REFLECT( myeosio::chain_apis::read_only::get_abi_params, (account_name) )
FC_REFLECT( myeosio::chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( myeosio::chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
FC_REFLECT( myeosio::chain_apis::read_only::abi_json_to_bin_result, (binargs) )
FC_REFLECT( myeosio::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
FC_REFLECT( myeosio::chain_apis::read_only::abi_bin_to_json_result, (args) )
FC_REFLECT( myeosio::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
FC_REFLECT( myeosio::chain_apis::read_only::get_required_keys_result, (required_keys) )
