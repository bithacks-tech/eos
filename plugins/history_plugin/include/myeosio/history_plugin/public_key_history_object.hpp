...
CHAINBASE_SET_INDEX_TYPE( myeosio::public_key_history_object, myeosio::public_key_history_multi_index )

FC_REFLECT( myeosio::public_key_history_object, (public_key)(name)(permission) )
