...
CHAINBASE_SET_INDEX_TYPE( myeosio::account_control_history_object, myeosio::account_control_history_multi_index )

FC_REFLECT( myeosio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
