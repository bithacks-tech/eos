...
#include <myeosio/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key MES6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( myeosio::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( myeosio::wallet::plain_keys, (checksum)(keys) )
