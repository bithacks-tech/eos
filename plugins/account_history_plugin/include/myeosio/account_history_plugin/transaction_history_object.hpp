...
CHAINBASE_SET_INDEX_TYPE( myeosio::transaction_history_object, myeosio::transaction_history_multi_index )

FC_REFLECT( myeosio::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
