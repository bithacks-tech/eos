...
namespace std {
   ...
   template<>
   struct hash<myeosio::chain::account_name>
   {
    size_t operator()( const myeosio::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( myeosio::account_transaction_history_object, myeosio::account_transaction_history_multi_index )

FC_REFLECT( myeosio::account_transaction_history_object, (name)(transaction_id) )
