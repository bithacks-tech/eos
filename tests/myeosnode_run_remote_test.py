...
###############################################################
# myeosnode_run_remote_test
#  Tests remote capability of the myeosnode_run_test. Test will setup cluster and pass nodes info to myeosnode_run_test. E.g.
#  myeosnode_run_remote_test.py -v --clean-run --dump-error-detail
###############################################################
...
pnodes=1
total_nodes=pnodes
actualTest="tests/myeosnode_run_test.py"
...
try:
    ...
    Print("Starting up %s test: %s" % ("myeosnode", actualTest))
    Print("cmd: %s\n" % (cmd))
