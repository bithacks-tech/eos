...
#include <myeosio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::global_property_object, myeosio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::dynamic_global_property_object,
                         myeosio::chain::dynamic_global_property_multi_index)

FC_REFLECT(myeosio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(myeosio::chain::global_property_object,
