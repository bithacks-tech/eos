...
FC_REFLECT(myeosio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(myeosio::chain::key_weight, (key)(weight) )
FC_REFLECT(myeosio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(myeosio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(myeosio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
