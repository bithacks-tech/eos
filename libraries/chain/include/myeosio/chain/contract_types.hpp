...
using action_name    = myeosio::chain::action_name;
...
FC_REFLECT( myeosio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( myeosio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( myeosio::chain::setabi                           , (account)(abi) )
FC_REFLECT( myeosio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( myeosio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( myeosio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( myeosio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( myeosio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( myeosio::chain::onerror                          , (sender_id)(sent_trx) )
