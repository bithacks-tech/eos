...
namespace myeosio { namespace chain {
    ...
    *  In the context of myeosio, every action is dispatched to the handler defined
...
FC_REFLECT( myeosio::chain::permission_level, (actor)(permission) )
FC_REFLECT( myeosio::chain::action, (account)(name)(authorization)(data) )
