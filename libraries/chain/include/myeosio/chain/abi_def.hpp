...
struct abi_def {
   ...
   string                version = "myeosio::abi/1.0";
...
FC_REFLECT( myeosio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( myeosio::chain::field_def                        , (name)(type) )
FC_REFLECT( myeosio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( myeosio::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( myeosio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( myeosio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( myeosio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( myeosio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
