#pragma once
#include <myeosio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( myeosio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(myeosio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(myeosio::chain::transaction_receipt, (myeosio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(myeosio::chain::signed_block, (myeosio::chain::signed_block_header), (transactions)(block_extensions) )
