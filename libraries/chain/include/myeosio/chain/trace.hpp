...
FC_REFLECT( myeosio::chain::base_action_trace,
                    (receipt)(act)(elapsed)(cpu_usage)(console)(total_cpu_usage)(trx_id) )

FC_REFLECT_DERIVED( myeosio::chain::action_trace,
                    (myeosio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( myeosio::chain::transaction_trace, (id)(receipt)(elapsed)(net_usage)(scheduled)
                                             (action_traces)(failed_dtrx_trace)(except) )
FC_REFLECT( myeosio::chain::block_trace, (elapsed)(billed_cpu_usage_us)(trx_traces) )
