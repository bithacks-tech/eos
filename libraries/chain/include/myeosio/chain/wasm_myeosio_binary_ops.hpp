...
namespace myeosio { namespace chain { namespace wasm_ops {
...
struct field_specific_params {
   ...
   static void pack(instruction_stream* stream, Field& f) { return myeosio::chain::wasm_ops::pack(stream, f); }
   static auto to_string(Field& f) { return std::string(" ")+
                                       myeosio::chain::wasm_ops::to_string(f); }
};
template <>
...
FC_REFLECT_TEMPLATE( (typename T), myeosio::chain::wasm_ops::block< T >, (code)(rt) )
FC_REFLECT( myeosio::chain::wasm_ops::memarg, (a)(o) )
FC_REFLECT( myeosio::chain::wasm_ops::blocktype, (result) )
FC_REFLECT( myeosio::chain::wasm_ops::memoryoptype, (end) )
