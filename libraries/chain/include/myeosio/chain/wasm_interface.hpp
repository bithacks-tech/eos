...
namespace myeosio { namespace chain {
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against MyEOSIO specific constraints
      ...
      private:
         ...
         friend class myeosio::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( myeosio::chain::wasm_interface::vm_type, (wavm)(binaryen) )
