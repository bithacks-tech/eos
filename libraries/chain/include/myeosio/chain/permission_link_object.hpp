...
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::permission_link_object, myeosio::chain::permission_link_index)

FC_REFLECT(myeosio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
