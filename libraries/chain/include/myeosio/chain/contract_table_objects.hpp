...
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::table_id_object, myeosio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::key_value_object, myeosio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(myeosio::chain::index64_object, myeosio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::index128_object, myeosio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::index256_object, myeosio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::index_double_object, myeosio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::index_long_double_object, myeosio::chain::index_long_double_index)

FC_REFLECT(myeosio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(myeosio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
