...
using namespace fc;
using namespace myeosio::chain::webassembly;
using namespace IR;
...
#define _REGISTER_INJECTED_INTRINSIC(R, CLS, INFO)\
   BOOST_PP_CAT(BOOST_PP_OVERLOAD(_REGISTER_INTRINSIC, _UNWRAP_SEQ INFO) _EXPAND_ARGS(CLS, MYEOSIO_INJECTED_MODULE_NAME, INFO), BOOST_PP_EMPTY())
