...
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::block_summary_object, myeosio::chain::block_summary_multi_index)

FC_REFLECT( myeosio::chain::block_summary_object, (block_id) )
