...
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::permission_object, myeosio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(myeosio::chain::permission_usage_object, myeosio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<myeosio::chain::permission_object>, (_id))
FC_REFLECT(myeosio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<myeosio::chain::permission_usage_object>, (_id))
FC_REFLECT(myeosio::chain::permission_usage_object, (id)(last_used))
