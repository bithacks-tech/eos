#include "../../../chain/include/myeosio/chain/wasm_myeosio_constraints.hpp"
...
namespace WASM
{
	...
	void serializeFunctionBody(InputStream& sectionStream,Module& module,FunctionDef& functionDef)
	{
      ...
      constexpr size_t max_size = myeosio::chain::wasm_constraints::maximum_code_size;
	...
	void serializeImportSection(Stream& moduleStream,Module& module)
	{
		serializeSection(moduleStream,SectionType::import,[&module](Stream& sectionStream)
		{
         ...
         constexpr size_t max_size = myeosio::chain::wasm_constraints::maximum_section_elements;
			if(Stream::isInput)
			{
