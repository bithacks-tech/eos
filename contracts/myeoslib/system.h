...
extern "C" {
    ...
    */
   void  myeosio_assert( uint32_t test, const char* msg );
    ...
    */
   void  myeosio_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  myeosio_assert_code( uint32_t test, uint64_t code );
    ...
    */
   [[noreturn]] void  myeosio_exit( int32_t code );
