         ...
         static void on(const trigger& act)
         {
            ...
            switch(act.what)
            {
               case 0:
               {
                  ...
                  myeosio::multi_index<N(orders), limit_order,
               ...
               case 1: // Test key265 secondary index
               {
                  ...
                  myeosio::multi_index<N(test1), test_k256,
               ...
               break;
               default:
                  myeosio_assert(0, "Given what code is not supported.");
               break;
            }
         }
   };
...
namespace multi_index_test {
   extern "C" {
      ...
      void apply( uint64_t /* receiver */, uint64_t code, uint64_t action ) {
         require_auth(code);
         myeosio_assert(myeosio::dispatch<multi_index_test, multi_index_test::trigger>(code, action),
                      "Could not dispatch");
      }
   }
}
