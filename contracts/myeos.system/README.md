...
## myeos.system::cfgproducer    account config
...
## myeos.system::okproducer     account producer vote
...
## myeos.system::setproxy       account proxy
...
## myeos.system::unstake        account quantity 
...
## myeos.system::withdraw account
   - this action can only be triggered by myeos.system via a deferred transaction generated by unstake
   - this will generate an inline myeos.token::transfer call from=myeos.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## myeos.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## myeos.system::stakevote account amount
   - the primary currency of myeosio is controlled by the token contract which enables users to transfer
...
## myeos.system::onblock   account blocktime blocknum
...
## myeos.system::freeze producer accounts true|false 
...
## myeos.system::paystandby producer
